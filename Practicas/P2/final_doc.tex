...
\begin{document}
  ...
  \section{Apartado 1}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=1\linewidth]{img/esquematico_ampl.png}
  ...
  \section{Apartado 2}
    ...
    \paragraph*{}
    Después de montar el circuito y comprobar que las conexiones son correctas y corresponden con el circuito esquemático (figura \ref*{fig:esque_ampl}), 
    el siguiente paso es proceder a realizar medidas para diferentes valores de entrada tanto de frecuencia como de amplitud. 
    
    \paragraph*{}
    En la siguiente tabla, podemos ver las medidas realizadas y los resultados obtenidos tanto de ganancia como de señal de salida. 
...
\vspace*{1.0cm}
  ...
  \section{Apartado 3}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=1\linewidth]{img/bode_real.png}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=1\linewidth]{img/bode_ideal.png}
    ...
    Por otro lado, el comportamiento de la fase no de uno y el otro no corresponden porque en la práctica sólo se midieron valores de amplitud. 
  ...
  \section{Apartado 4}
    ...
    \paragraph*{}
    Utilizando los valores de 11 kHz y con una tensión de entrada de 1000 mV (valores con los que se obtiene la máxima ganancia en el circuito real), se puede medir 
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=1\linewidth]{img/resis_bobina.png}
