    ...
    \begin{table}[H]
      \begin{center}
          \begin{tabular}{| c | c | c | c |}
              \hline
              \rowcolor{black}
              \textcolor{white}{Frecuencia de referencia (kHz)} & \textcolor{white}{Frecuencia de salida de VCO (kHz)} & \textcolor{white}{Retardo (us)} & \textcolor{white}{Amplitud de entrada VCO (V)}\\ \hline
