...
\begin{document}
  ...
  \section*{Apartado 1}
    ...
    De esta forma, el código para generar las anteriores funciones, así como las variables necesarias, es el siguiente:

    %%aquí va una imagen del código

    \paragraph*{}
    Con el anterior código, se obtiene la siguiente salida:

    %%aquí va una imagen de la salida obtenida
